...
const notifications = [
  {
    ...
    message:
      "Mitra telah meminta perubahan pada paket wisata. Mohon tinjau dan ambil tindakan pada permintaan ini.",
    time: "baru",
    icon: "partner",
  },
  {
    ...
    title: "Perlu Ditinjau!",
    message:
      "Ada mitra baru yang meminta aktivasi akun. Mohon tinjau dan ambil tindakan pada permintaan ini.",
    time: "11.40",
    icon: "package",
  },
];
  ...
  return (
    <header className="fixed left-[200px] right-0 top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background px-6">
      <div className="relative w-[400px]">
        ...
        <Input type="search" placeholder="Cari" className="bg-muted/50 pl-10" />
      </div>
